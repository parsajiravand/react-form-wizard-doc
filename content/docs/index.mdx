...
The default appearance was redesigned, and dark mode now works without
configuration. The v1 look is still available:
...
Nothing else changed — see [Migration](/docs/migration#from-12x--200).
...
| [Theming](/docs/guides/theming) | CSS custom properties, automatic dark mode, or go fully unstyled. |
| [Tailwind](/docs/guides/tailwind) | Adopt your Tailwind theme with one import, or build it from utility classes. |

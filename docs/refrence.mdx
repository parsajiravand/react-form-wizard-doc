...
| `reset()` | Reset to the configured start index. |
| `setData(data)` | Update schema data programmatically. |
| `getData()` | Read current schema data from wizard runtime. |
...
See also: [Props](/docs/props) and [Event Handling](/docs/event).
